...
class ErnieModel(object):
    def __init__(self,
        ...
        self._pos_emb_name1 = "pos_embedding1"
        self._pos_emb_name2 = "pos_embedding2"
        ...
        self._build_model(src_ids, position_ids, position_ids1, position_ids2, sentence_ids, task_ids,
                          input_mask)

    def _build_model(self, src_ids, position_ids, position_ids1, position_ids2, sentence_ids, task_ids,
                     input_mask):
        ...
        position1_emb_out = fluid.layers.embedding(
            input=position_ids1,
            size=[self._max_position_seq_len + 300, self._emb_size],
            dtype=self._emb_dtype,
            param_attr=fluid.ParamAttr(
                name=self._pos_emb_name1, initializer=self._param_initializer))

        position2_emb_out = fluid.layers.embedding(
            input=position_ids2,
            size=[self._max_position_seq_len + 300, self._emb_size],
            dtype=self._emb_dtype,
            param_attr=fluid.ParamAttr(
        ...
        emb_out = emb_out + position_emb_out + position1_emb_out + position2_emb_out
